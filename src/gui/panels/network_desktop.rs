...
/// Render the network & desktop panel. Always returns `true`.
pub fn show(ui: &mut Ui, packages: &mut PackagesState, filesystem: &Filesystem) -> bool {
    widgets::page_heading(ui, "Network & Desktop");
