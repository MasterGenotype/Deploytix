...
///
/// Creating it is not proof: a read-only mount can hold an already-existing
/// directory, and `create_dir_all` succeeds on one that is already there. The
