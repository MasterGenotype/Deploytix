...
#
# The hand-written desktop-session wrapper as it stood from 2026-05-04
# (2b63d6e) to 2026-08-29 (ea0be34), when it was replaced by the per-desktop
# generator in configure::session_switching::render_desktop_session.
#
# Kept because this version ran on a working handheld for four months, so it is
# the behaviour the generated template is compared against. The live file is
# generated from src/resources/session_switching/desktop-session.sh and
# installed to /usr/local/bin/desktop-session. Nothing includes or deploys this
# copy.
#
# To get it back byte for byte:
#   git show 2b63d6e:src/resources/session_switching/desktop-session.sh
# ==================================================
